...
```javascript
gjoinBetween = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gjoin-between@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var gjoinBetween = require( 'path/to/vendor/umd/blas-ext-base-gjoin-between/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gjoin-between@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gjoin-between.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gjoin-between

[test-image]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gjoin-between/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gjoin-between?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gjoin-between.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gjoin-between/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-gjoin-between/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-gjoin-between/main/LICENSE
